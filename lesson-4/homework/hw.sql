...
Create database Homework_leeson4

use Homework_leeson4

--Kerak bo'ladigan barcha jadvallar ro'yahati--
...
SELECT *
FROM Orders
WHERE OrderDate BETWEEN DATE_SUB(CURRENT_DATE, INTERVAL 180 DAY) AND CURRENT_DATE;
