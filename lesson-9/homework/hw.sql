...
(13, 'Kim', 'Anderson', 'kima@gmail.com', '555-3456', '111 Pine Ave', 'Paris', 'Оle-de-France', '75001', 'France'),
(14, 'Liam', 'Thomas', 'liamt@yahoo.com', '555-4567', '222 Cedar Ave', 'Lyon', 'Auvergne-Rhфne-Alpes', '69001', 'France'),
(15, 'Megan', 'Taylor', 'megant@outlook.com', '555-5678', '333 Redwood Ave', 'Marseille', 'Provence-Alpes-Cфte Azur', '13001', 'France'),
...
select Departments.DepartmentName, Employees.Name from Departments
...
Select s.saleID , s.saleamount, c.firstname + c.lastname
from sales s 
JOIN customers c ON s.CustomerID=c.CustomerID
Where c.Country= 'USA'
...
SELECT o.OrderID, c.FirstName + c.LastName as Full_name, o.TotalAmount
FROM Orders o
JOIN Customers c ON o.CustomerID = c.CustomerID
